...
class DataFrame:
    ...
    def df_creation(self):
        ...
        #   il dataframe creato potrà quindi essere dato in pasto a scipy.sparse.csgraph.reverse_cuthill_mckee. Decidere quindi
        #   se farlo direttamente all'interno di questa classe (importando scipy qui) oppure nel main.
        return
